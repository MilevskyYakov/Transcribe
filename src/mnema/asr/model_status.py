...
MODEL_DIR_ENV = "MNEMA_MODEL_DIR"
LEGACY_MODEL_DIR_ENV = "TRANSCRIBE_DOC_MODEL_DIR"
...
def model_root_dir() -> Path | None:
    value = os.getenv(MODEL_DIR_ENV) or os.getenv(LEGACY_MODEL_DIR_ENV)
    if not value:
        return None
...
def transcribe_model_cache_dir() -> Path:
    ...
    return default_cache_root() / "mnema" / "models"
