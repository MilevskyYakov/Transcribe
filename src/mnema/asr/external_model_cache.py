...
from mnema.asr.model_registry import ExternalModelSpec, external_spec
...
from mnema.asr.whisper_cache import sha256
...
def mark_model_download_queued(model_name: str, position: int | None = None) -> None:
    spec = external_spec(model_name)
    if spec is None:
        from mnema.asr.whisper_cache import model_path_for, model_url_for
