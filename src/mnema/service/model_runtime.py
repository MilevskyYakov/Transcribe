...
from mnema.asr.whisper_cache import download_whisper_model, inspect_whisper_models
from mnema.service.contracts import dataclass_payload, model_status_response
...
def model_download_state_for_response(
    model: dict[str, Any], active_downloads: set[str]
) -> dict[str, Any]:
    ...
    return dataclass_payload(model_status_response(model))
