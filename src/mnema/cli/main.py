...
from mnema.app.constants import APP_NAME, DEFAULT_CONFIG_PATH
from mnema.app.exceptions import CommandNotImplementedError, ConfigurationError
from mnema.app.logging import configure_logging
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    try:
        ...
        if app_data_dir:
            ...
            os.environ["MNEMA_MODEL_DIR"] = str(app_data_path / "models")
